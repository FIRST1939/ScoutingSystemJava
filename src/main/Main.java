...
/**
 * The main class where the main method resides. This version should seamlessly
 * integrate the two types of controllers we use.
 * 
...
public class Main {
	...
	public static UIV2 ui = new UIV2();
