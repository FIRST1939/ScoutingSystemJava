...
public class ControllerTest {
					...
					Runnable setTriggerAnalogValues = new Runnable() {
						...
						public void run() {
							if (name.equalsIgnoreCase("Z Axis")) {
								if (Math.round(analogValue) == 1)
									lt = true;
								else if (Math.round(analogValue) != 1)
									lt = false;
								if (Math.round(analogValue) == -1)
									rt = true;
								else if (Math.round(analogValue) != -1)
	...
	public static void outputAllVariables() {
		...
		if (leftStick == NEUTRAL)
			System.out.println("Left Stick: Neutral");
		else if (leftStick == UP)
		...
		else if (leftStick == ERROR)
			System.out.println("Left Stick: Error");
		if (rightStick == NEUTRAL)
			System.out.println("Right Stick: Neutral");
		else if (rightStick == UP)
			System.out.println("Right Stick: Up");
		else if (rightStick == DOWN)
			System.out.println("Right Stick: Down");
		else if (rightStick == LEFT)
			System.out.println("Right Stick: Left");
		else if (rightStick == RIGHT)
			System.out.println("Right Stick: Right");
		else if (rightStick == UP_LEFT)
			System.out.println("Right Stick: Up Left");
		else if (rightStick == UP_RIGHT)
			System.out.println("Right Stick: Up Right");
		else if (rightStick == DOWN_LEFT)
			System.out.println("Right Stick: Down Left");
		else if (rightStick == DOWN_RIGHT)
			System.out.println("Right Stick: Down Right");
		else if (rightStick == ERROR)
			System.out.println("Right Stick: Error");
		System.out.println();
	}
